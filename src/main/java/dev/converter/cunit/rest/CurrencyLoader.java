package dev.converter.cunit.rest;
...
public class CurrencyLoader {
    ...
    public void loadCurrencyRates() throws Exception {
        try {
            ...
            try (Scanner scanner = new Scanner(new File(CACHED_RATES))) {
                ...
                // overwrite leftover values within rates if an exception has occurred
    ...
    public static void main(String[] args) throws Exception {
        ...
        // in order to try and load the newest data on program start up
